...
# ============================================
# ПОСЛЕДНЯЯ ПОПЫТКА - ИЩЕМ JSON ГДЕ УГОДНО
# ============================================
...
possible_paths = [
    root_dir / "data",                    # /data
    parent_dir / "data",                   # /data (если родитель = /)
    current_dir / "data",                   # /bot/data
    root_dir / "opt" / "render" / "project" / "src" / "data",  # стандартный Render
...
if not DATA_DIR:
    ...
    logging.error("📌 СОЗДАЁМ ПАПКУ /data ДЛЯ РУЧНОЙ ЗАГРУЗКИ")
    DATA_DIR = Path("/data")
